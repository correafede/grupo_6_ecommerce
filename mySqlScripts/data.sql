...
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (16,"Peñón del Águila Arándano Sour",3 ,2 ,1 ,4 , 0,"Buscando siempre experiencias superadora, Peñón del Águila nos trae su última creación: las cervezas ácidas. De bajo alcohol y amargor, se trata de una propuesta refrescante y de alta tomabilidad. Sus latas nos trasladan a lugares exóticos y cálidos, que resaltan la frescura y acidez de estas cervezas. \r\n\r\nInspiradas en las Catharinas sour the Brasil, los maestros cerveceros de Peñón del Águila nos traen la Arándano Sour. La acidez, limpia, delicada y refrescante de este tipo de cerveza es aportado por el accionar de Lactobacilus. Es en la etapa de la fermentación cuando se agregan los arándanos, aportando el balance, el sabor frutal y el color violeta cristalino característico de la esta cerveza. Sin dudas una opción exótica, ideal para quienes les encanta probar sabores y experiencias nuevas. ",
300, 0,100, 'penon-del-aguila-arandano-sour.webp', 'cerveza cervezas beer Peñón del Águila Arándano Sour Lata 473ml');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (17,"Jamonera",2 ,2 ,1 ,5.5 , 0,"Cerveza de alta fermentación estilo Amber Ale elaborada con maltas tostadas y caramelizadas. Tostada y de color rojizo es perfecta para acompañar un buen pedazo de jamón, embutidos ibéricos y carne a la brasa. ",
490, 0,100, 'cerveza-jamonera-amber.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (18,"Andes Origen Roja",3 ,2 ,1 ,5.5 , 0,"Andes Origen rescata el placer del momento. Una cerveza pensada para aquellas personas que valoran su tiempo libre, para quienes disfrutan de los pequeños momentos de la vida. La opción ideal para quienes quieren mimarse.\r\n\r\nLa Andes Origen Roja a es una cerveza que posee un final seco y una leve acidez que la hacen muy versátil. Es una cerveza estilo Vienna Lager, su aroma a suave caramelo y leve lúpulo logran un balance perfecto. La Andes origen Roja, color ámbar cobrizo, es una cerveza de deleite. Ideal para acompañar pescados o carnes rojas, elaborados con verduras frescas o grilladas. Pastas, ya sean con o sin relleno, con salsas suaves de tomate o con un toque de crema. Crumble de manzana o de pera.",
212, 0,100, 'andes-origen-roja.webp', 'cerveza cervezas beer roja');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (19,"Peñón del Águila Waldbier",3 ,2 ,1 ,5.3 , 0,"Te traemos la \"Cerveza del Bosque\". Una cerveza lager a la que se le agrega frambuesa, logrando ese aroma y sabor tan característico. De bajo amargor e intenso sabor, una cerveza fresca y veraniega para compartir con amigos. ",
300, 0,100, 'penon-del-aguila-waldbier.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
260, 0,100, 'penon-del-aguila-oktoberfest.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
590, 0,100, 'birra-del-borgo.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
396, 15,100, 'cerveza-patagonia-kune.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
350, 10,100, 'cerveza-blest-apa.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
450, 13,100, 'patagonia-escandinapa.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
565, 5,100, 'leffe-ruby.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
270, 0,100, 'me-hecho-la-burra-roja.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
290, 0,100, 'me-hecho-la-burra-pecadora.webp', 'cerveza cervezas beer'); 
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (28,"Straus Red Ale 355ml",3 ,3 ,1 ,4.5 , 70, "Straus Red Ale es una cerveza de color ámbar, aroma a tostado y notas a caramelo, con un grado de amargor pronunciado. Contenido alcohólico medio de 4.5%. Es una Cerveza Libre de Gluten.",
300, 0,100, 'straus-redale.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (29,"Peñón del Águila American Amber Lager Lata 473ml",3 ,3 ,1 ,5.6 , 32, "Esta variedad de Peñón del Águila es una lager de intenso color ámbar, con destellos de rubí y una espuma compacta y clara. Presente un aroma complejo donde la fruta tropical, durazno y cítricos de los lúpulos americanos se combinan con notas a caramelo de las maltas especiales. Ideal para acompañar fiambres, carnes asadas, quesos y postres en base a fruta.",
370, 0,100, 'penon-del-aguila-american-lager.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (30,"Peñón del Águila Barley Wine Lata 354ml",3 ,3 ,1 ,10, 63, "La Barley Wine tiene la característica de ser una cerveza extremadamente maltosa. Como su nombre lo indica, es un vino de cebada, con un alto contenido alcohólico. Para su elaboración, usamos 9 maltas nacionales e importadas de Inglaterra y lúpulos ingleses para darle el perfil tradicional del estilo.",
480, 15,100, 'penon-del-aguila-barley-wine.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
280, 15,100, 'penon-del-aguila-honigbier.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
301, 10,100, 'cerveza-blest-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
280, 10,100, 'bierhaus-honey-sweetheart.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
340, 0,100, 'straus-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
340, 0,100, 'portlander-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
290, 10,100, 'ocaso-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
350, 5,100, 'demon-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
350, 15,100, 'darwin-monarca-honey.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
350, 10,100, 'temple-blest.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
290, 0,100, 'ocaso-honey-sinalcohol.webp', 'cerveza cervezas beer'); 
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
550, 0,100, 'temple-kandy-kush.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
370, 0,100, 'penon-del-aguila-arandano-sour.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
370, 15,100, 'penon-del-aguila-maracuya-sour.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (44,"Peñón del Águila Maracuyá Sour Lata 473ml",3 ,8 ,1 ,4, 7, "La nueva Cerveza ácida de Peñön con jugo de uva Frambua (Uva típica de Córdoba). Es una cerveza , refrescante y delicada con 4% de alcohol, con el perfil frutado característico de esta uva que aporta notas a ciruela y frutos tropicales. Peñón del Águila es una cervecería de la provincia de Córdoba, pionera entre las cervecerías artesanales en el uso de latas para sus productos. Fieles a la ley de pureza en (casi) todos sus estilos.",
370, 10,100, 'penon-del-aguila-isabella-sour.webp', 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
620, 10,100, "erdinger-weissbier.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (46,"Me Echó La Burra Blanca 330ml", 2, 5, 1, 4.8, 10, "Me Echó La Burra es una cerveza especial y artesanal elaborada según la tradición belga a base de cebada malteada, lúpulo y levaduras de calidad. La Blanca es una cerveza de trigo con aromas cítricos propios de las ales de trigo.",
270, 15,100,"me-hecho-la-burra-blanca.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
290, 0,100,"ocaso-tiramisu-porter.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
450, 10,100,"almirante-donn-nother.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
300, 15,100,"traumer-porter.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
290, 0,100,"ocaso-weisse.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
...
480, 0,100,"cerveza-weidmann-hefetrub.webp", 'cerveza cervezas beer');


INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (54,"Cerveza Franziskaner Weissbier Hell 500ml",4,9 ,5 ,4, 5, "Franziskaner Weissbier Hell es una cerveza tipo Hefeweissbier blanca de Baviera con espuma blanca exuberante. De aroma frutal, se destaca por su sabor a banana y cítricos. Fresca y sutilmente especiada, se caracteriza por su sabor dulce al final de cada trago.",
520, 10,100,"franziskaner-hell.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUES
 (55,"Cerveza Franziskaner Weissbier Dunkel 500ml" ,4 ,9 ,3 ,5, 10, "La Dunkel de Franziskaner es una cerveza con mucha personalidad. Como sus nombres lo indican (Weissbier = cerveza de trigo y Dunkel = oscura) esta variedad genera una espuma de color cremoso a partir de su color oscuro y turbidez, producto del no filtrado de la cerveza. Es conocida por su aroma típico a banana proveniente de la levadura, combinado con caramelo por las maltas utilizadas. De sabor frutado al principio y especiado sobre el final, es sin dudas un claro exponente de este estilo alemán.",
520, 10,100,"franziskaner-dunkel.webp", 'cerveza cervezas beer');
...
(56,"Cerveza Peñón del Águila Waldbier Lata 473ml" ,3 ,9 ,2 ,5.3, 10, "Te traemos la Cerveza del Bosque. Una cerveza lager a la que se le agrega frambuesa, logrando ese aroma y sabor tan característico. De bajo amargor e intenso sabor, una cerveza fresca y veraniega para compartir con amigos. ",
370, 0,100,"penon-del-aguila-waldbier.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUE
(57,"Cerveza Jamonera Pale Ale 355ml" ,2 ,9 ,1 ,5.5, 10, "Cerveza rubia que utiliza 3 veces más lúpulo que una cerveza normal. Sorprende por su inmenso sabor afrutado y frescura. Muy equilibrada, maltosa y amarga. Ideal para maridar con quesos grasos y fuertes. Al ser sin filtrar puede contener sedimentos en el fondo de la botella.",
450, 0,100,"cerveza-jamonera-pale-ale.webp", 'cerveza cervezas beer');
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUE
(58,"Cerveza Dos Dingos Pacific Pale Ale 473ml" ,3 ,9 ,1 ,4.8, 6, "La Cerveza Pacific Pale Ale es una Australian Pale Ale moderna con un perfil de maltas de complejidad media con notas a pan y galletita provenientes de un pequeño porcentaje de maltas Carahell y Múnich. El perfil de lúpulos, liderado por el gran Galaxy Australiano, realza el perfil tropicales como maracuya, durazno y naranja. De final seco y amargor balanceado, es ideal para los amantes de las Pale Ales con notas tropicales.",
345, 9,100,"dos-dingos-lata-aussie-ipa.webp", 'cerveza cervezas beer');

INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUE (1,"Cerveza Me Echó La Burra Negra 8 330mll" ,1 ,6 ,4 ,8, 5, "Me Echó La Burra es una cerveza especial y artesanal elaborada según la tradición belga a base de cebada malteada, lúpulo y levaduras de calidad. Es una cerveza de doble fermentación en botella y doble maduración en bodega. La Negra 8 es una ale de marcado aroma a chocolate, con notas en boca de chocolate y café.",
270, 10,100,"me-hecho-la-burra-negra.webp");
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUE (2,"Cerveza Quilmes Stout Lata 473ml" ,3 ,6 ,3 ,4.8, 10, "Elaborada con maltas tostadas que le otorgan su particular aroma, la cerveza Quilmes Stout es una lager oscura que se destaca por su cuerpo y espuma cremosa, recordando al sabor del chocolate y al amargor del café.",
149, 0,100,"quilmes-stout.webp");
INSERT INTO cervezas (idCerveza, Nombre, id_Size, id_Category, id_Color, abv, ibu, descrip, price, discount, quantity, image, tags) VALUE (3,"Cerveza Portlander Stout Bohemia Lata 473ml" ,3 ,6 ,4 ,6, 30, "La Cerveza Portlander Stout Bohemia, es una cerveza negra azabache con perfil aromático intenso a café y chocolate. Cuerpo sedoso y espuma cremosa, característica otorgada por la avena orgánica.",
340, 10,100,"portlander-stout.webp");